...
class LoginFirebasePageMobile extends StatefulWidget {
  const LoginFirebasePageMobile({super.key});

  @override
  State<LoginFirebasePageMobile> createState() =>
      _LoginFirebasePageMobileState();
}

class _LoginFirebasePageMobileState extends State<LoginFirebasePageMobile> {
